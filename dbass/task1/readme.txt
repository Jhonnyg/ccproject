...
the diagram. For example, the domain description tells us that we should be
able to see if a student is able to graduate depending on a set of
requirements. It should be possible to see if a student has passed (hasTaken
relation) the mandatory courses (programme and branchMandatory relations),
which could belong to a certain class of courses (certifiedAs relation). 
